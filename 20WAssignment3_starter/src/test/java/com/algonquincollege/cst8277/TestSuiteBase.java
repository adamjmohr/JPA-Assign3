...
public class TestSuiteBase {
    ...
    /**
     * Build factory manager before hand.
     */
    @BeforeClass
    ...
    /**
     * Tear down factory manager after wards and close entity manager.
     */
    @AfterClass
    ...
    public static EntityManagerFactory buildEntityManagerFactory() {
        ...
        try {
            ...
            //properties.put(JDBC_URL, H2_SERVER_URL);
